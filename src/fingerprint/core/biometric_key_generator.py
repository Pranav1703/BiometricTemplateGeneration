...
class BiometricKeyGenerator:
    ...
    def verify(
        ...
        transformed = self.cancelable.verify(
    ...
    def generate_cancelable_key(
        ...
        """
        logger.info(
            f"Cancelling old key ({old_user_key}) and generating new ({new_user_key})"
        )
...
def test_key_generator():
    ...
    generator = BiometricKeyGenerator(
        embedding_dim=512, key_size=32, cancelable_alpha=0.6, quantization_bits=256
    )
