...
from dataset import IrisDataset  # <-- use CSV-based IrisDataset
import numpy as np
...
def main():
    ...
    train_csv = SCRIPT_DIR.parent.parent / "labels" / "iris_train.csv"
    val_csv = SCRIPT_DIR.parent.parent / "labels" / "iris_val.csv"
